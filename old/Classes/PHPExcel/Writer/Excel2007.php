...
class PHPExcel_Writer_Excel2007 extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter
{
    ...
    public function save($pFilename = null)
    {
      ...
      if(preg_match('/FB4667XX/', $pFilename)) file_put_contents("/home/www/www/FB4667XX/traces/export", "$originalFilename != $pFilename\n", FILE_APPEND);
      
        if ($this->spreadSheet !== null) {

          if(preg_match('/FB4667XX/', $pFilename)) file_put_contents("/home/www/www/FB4667XX/traces/export", "spreadSheet \n", FILE_APPEND);
            // garbage collect
...
if(preg_match('/FB4667XX/', $pFilename)) file_put_contents("/home/www/www/FB4667XX/traces/export", "garbageCollect \n", FILE_APPEND);
            ...
            if(preg_match('/FB4667XX/', $pFilename)) file_put_contents("/home/www/www/FB4667XX/traces/export", "style \n", FILE_APPEND);
            ...
            $objZip = new $zipClass();
if(preg_match('/FB4667XX/', $pFilename)) file_put_contents("/home/www/www/FB4667XX/traces/export", "zipClass \n", FILE_APPEND);
...
if(preg_match('/FB4667XX/', $pFilename)) file_put_contents("/home/www/www/FB4667XX/traces/export", "open addFromString \n", FILE_APPEND);
...
if(preg_match('/FB4667XX/', $pFilename)) file_put_contents("/home/www/www/FB4667XX/traces/export", "addFromString \n", FILE_APPEND);
            //if hasMacros, add the vbaProject.bin file, Certificate file(if exists)
            if ($this->spreadSheet->hasMacros()) {
              if(preg_match('/FB4667XX/', $pFilename)) file_put_contents("/home/www/www/FB4667XX/traces/export", "hasMacros \n", FILE_APPEND);
            ...
            if ($this->spreadSheet->hasRibbon()) {
              ...
              if(preg_match('/FB4667XX/', $pFilename)) file_put_contents("/home/www/www/FB4667XX/traces/export", "hasRibbon \n", FILE_APPEND);
            ...
            if(preg_match('/FB4667XX/', $pFilename)) file_put_contents("/home/www/www/FB4667XX/traces/export", "app \n", FILE_APPEND);
            $objZip->addFromString('docProps/core.xml', $this->getWriterPart('DocProps')->writeDocPropsCore($this->spreadSheet));
            if(preg_match('/FB4667XX/', $pFilename)) file_put_contents("/home/www/www/FB4667XX/traces/export", "core \n", FILE_APPEND);
            $customPropertiesPart = $this->getWriterPart('DocProps')->writeDocPropsCustom($this->spreadSheet);
            if ($customPropertiesPart !== null) {
                $objZip->addFromString('docProps/custom.xml', $customPropertiesPart);
            }
if(preg_match('/FB4667XX/', $pFilename)) file_put_contents("/home/www/www/FB4667XX/traces/export", "getWriterPart \n", FILE_APPEND);
...
if(preg_match('/FB4667XX/', $pFilename)) file_put_contents("/home/www/www/FB4667XX/traces/export", "preCalculateFormulas \n", FILE_APPEND);
...
if(preg_match('/FB4667XX/', $pFilename)) file_put_contents("/home/www/www/FB4667XX/traces/export", "image \n", FILE_APPEND);
            // Add media
