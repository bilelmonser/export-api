...
class PHPExcel_Writer_Excel5 extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter
{
    ...
    public function save($pFilename = null)
    {
      ...
      if(preg_match('/FB4667XX/', $pFilename)) file_put_contents("/home/www/www/FB4667XX/traces/export", "pFilename=$pFilename \n", FILE_APPEND);
...
if(preg_match('/FB4667XX/', $pFilename)) file_put_contents("/home/www/www/FB4667XX/traces/export", "addXfWriter \n", FILE_APPEND);
...
if(preg_match('/FB4667XX/', $pFilename)) file_put_contents("/home/www/www/FB4667XX/traces/export", "addFont \n", FILE_APPEND);
        // initialize OLE file
        ...
        if(preg_match('/FB4667XX/', $pFilename)) file_put_contents("/home/www/www/FB4667XX/traces/export", "PHPExcel_Shared_OLE_PPS_Root\n", FILE_APPEND);
        // save the OLE file
        $res = $root->save($pFilename);
if(preg_match('/FB4667XX/', $pFilename)) file_put_contents("/home/www/www/FB4667XX/traces/export", "save $pFilename \n", FILE_APPEND);
